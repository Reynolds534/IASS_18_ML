...
"%_pythonpath%"\python get-pip.py
pip install requests
"%_pythonpath%"\python DownloadWheels.py
...
"%_pythonpath%"\python -m pip install -U pip setuptools
"%_pythonpath%"\python -m pip install matplotlib==2.1.0